...
def send_welcome(message):
    """Welcome message handler with image and styled caption"""
    ...
    caption = (
        "𝗞𝗜𝗥𝗔𝗞 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 𝗠𝗣𝟯 - 𝗕𝗢𝗧\n\n"
        "សួស្តី! ជម្រាបសួរមកកាន់ KIRAK Download MP3 Bot\n\n"
        "📥 **របៀបប្រើប្រាស់:**\n"
        "គ្រាន់តែផ្ញើតំណ YouTube មកខ្ញុំ\n\n"
        "🌐 **គាំទ្រ:** YouTube, YouTube Shorts, YouTube Music\n"
        "🎧 **គុណភាព:** MP3 320kbps\n\n"
        "📞 **សម្រាប់ជំនួយ:** @kirak_itadori"
    )
...
def handle_download_mp3(call):
    ...
    try:
        ...
        if time_diff < REQUIRED_WAIT_TIME:
            ...
            bot.answer_callback_query(
                call.id,
                text=f"⚠️ មើលAds {remaining} វិនាទីទៀត ដើម្បីគាំទ្រ BOT យើងខ្ញុំ។",
                show_alert=True
            )
            return
...
if __name__ == '__main__':
    ...
    logger.info("✅ Welcome image configured")

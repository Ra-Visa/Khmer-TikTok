...
DOMAIN = "https://khmer-tiktok.onrender.com"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('code') == 0 and data.get('data'):
                ...
                if video_url:
                    # Download video content with headers to mimic browser
                    headers = {
                        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'
                    }
                    video_response = requests.get(video_url, timeout=30, headers=headers)
...
def create_ad_link(tiktok_url, chat_id):
    ...
    try:
        ...
        logger.info(f"Creating ShrinkMe.io link for: {verification_url}")
            ...
            if send_video_to_chat(chat_id, result['video_content'], caption):
                ...
                <html>
                    ...
                    <body style="font-family: Arial; text-align: center; padding: 50px;">
                        <h2 style="color: green;">✅ Video sent to Telegram!</h2>
                        <p>You can close this window and check your Telegram chat.</p>
                    </body>
                </html>
                ''', 200
            else:
                ...
                <html>
                    ...
                    <body style="font-family: Arial; text-align: center; padding: 50px;">
                        ...
                        <p>Please try again with another video.</p>
                    </body>
                </html>
                ''', 500
        else:
    ...
    <html>
        ...
        <body>
            <div class="container">
                ...
                <p>Bot is running! Send a TikTok link to @khmer_tiktok_bot on Telegram to download videos without watermark.</p>
                <div class="status">
                    ✅ Bot Status: Active<br>
                    📱 Username: @khmer_tiktok_bot
                </div>
            </div>
        </body>
    </html>
